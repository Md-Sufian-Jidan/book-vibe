...
const ReadDetails = ({book}) => {
    const { id ,title, publisher, book_type, rating, review, number_of_pages ,publish_year } = book;
    return (
        <div className="lg:flex gap-10 mx-28 border my-2">
            <div className="flex justify-center mx-28 my-5 bg-gray-300 p-3">
                ...
                <p className="mt-4"><span className="font-bold text-xl">Tag </span><span className="bg-gray-300 p-3 text-center rounded-[30px] text-[#23BE0A] font-bold text-lg mx-5">#{book?.tags[0]}</span><span className="bg-gray-300 p-3 text-center rounded-[30px] text-[#23BE0A] font-bold text-lg">#{book?.tags[1]}</span></p>
