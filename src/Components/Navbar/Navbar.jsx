        ...
        <div className="navbar bg-base-100 lg:px-28 px-5">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 mr-3">
                        ...
                        <NavLink className={({ isActive }) => isActive === true ? 'text-[#23BE0A] font-bold' : 'font-semibold'} to={'/bookSection'}>Book Section</NavLink>
                        <NavLink className={({ isActive }) => isActive === true ? 'text-[#23BE0A] font-bold' : 'font-semibold'} to={'/bookReview'}>Book Review</NavLink>
                    </ul>
                </div>
            ...
            <div className="navbar-center hidden lg:flex">
                <ul className="menu menu-horizontal px-1">
                    ...
                    <NavLink to={'/bookSection'} className={({ isActive }) => isActive === true ? 'text-[#23BE0A] border border-[#23BE0A] font-bold btn mr-2' : 'font-semibold btn mr-2'}>Books Section</NavLink>
                    <NavLink to={'/bookReview'} className={({ isActive }) => isActive === true ? 'text-[#23BE0A] border border-[#23BE0A] font-bold btn mr-2' : 'font-semibold btn mr-2'}>Book Review</NavLink>
